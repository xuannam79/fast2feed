	...
	<div class="panel panel-info">
    	<div class="panel-body" style="padding:0px">
       		<div class="list-group">
		        ...
		        <a href="{{ route('trangpostProduct') }}" class="list-group-item">Thêm sản phẩm</a>
		        <a href="{{ route('trangPost') }}" class="list-group-item">Thêm nhà hàng</a>
		        <a href="{{ route('trangThemMenu') }}" class="list-group-item">Thêm menu</a>
